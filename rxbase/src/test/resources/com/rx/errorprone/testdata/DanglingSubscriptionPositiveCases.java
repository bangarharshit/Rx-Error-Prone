...
public class DanglingSubscriptionPositiveCases {
  ...
  public void testSubscribeObservable() {
    // BUG: Diagnostic contains: Observable's subscription should be assigned to a disposable for cleanup
    Observable.just(1).subscribe();
  }

  public void testSubscribeWithObservable() {
    // BUG: Diagnostic contains: Observable's subscription should be assigned to a disposable for cleanup
    Observable.just(1).subscribeWith(new DisposableObserver<Integer>() {
